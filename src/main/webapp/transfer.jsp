...
<tr >
    ...
    <td width="1200" valign="top" style="border-right:#666666 1px dotted;">
		...
		<tr>
			<td>
				<form action="transferCheck.jsp" method="post">
				    <table cellspacing="5" cellpadding="3">
				    
					<tr><td>ACCOUNT NO:</td><td> <b> <%= session.getAttribute("accno")%> </b></td></tr>
					<tr><td>TARGET ACCOUNT NO:</td><td><input type="number" name="reciever"/></td></tr>
					...
					<td>
						<div class="button-container">
                            <input type="submit" value="TRANSFER" class="btn-change-pin"/>
