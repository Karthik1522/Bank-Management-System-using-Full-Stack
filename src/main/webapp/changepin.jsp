...
<style>
    ...
    display: flex;
    width : 100px;
    gap: 120px; /* Adjust the gap as needed */
}
...
<tr >
    ...
    <td width="1200" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="welcome"><h1>CHANGE PIN</h1><br>
		...
		<tr>
			<td>
				<form action="changepinCheck.jsp" method="post">
					...
					<tr><td>NEW PASSWORD:</td><td> <input type="password" name="cpassword" required/></td></tr>
					
					<tr>
					<td>
						<div class="button-container">
                            <input type="submit" value="CHANGE PIN" class="btn-change-pin"/>
